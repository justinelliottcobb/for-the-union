...
export const eliteStateManagementCategory: ExerciseCategory = {
  ...
  exercises: [
    ...
    },
    {
      ...
      testsPath: './src/exercises/elite-state-management/04-discriminated-union-state-patterns/tests.ts',
    ...
    },
    {
      ...
      testsPath: './src/exercises/elite-state-management/05-higher-kinded-types-state/tests.ts',
