...
export const performanceOptimizationCategory: ExerciseCategory = {
  ...
  exercises: [
    ...
    {
      id: '08-performance-monitoring',
      title: 'Performance Monitoring & Alerting',
      description: 'Master production performance monitoring, alerting systems, and comprehensive profiling tools',
      category: 'performance-optimization',
      difficulty: 5,
      prerequisites: ['react-hooks/02-useeffect-lifecycle', 'react-hooks/04-custom-hooks'],
      learningObjectives: [
      ...
      hints: [
        'Use PerformanceObserver API to monitor Core Web Vitals (LCP, FID, CLS)',
        'Implement memory monitoring with performance.memory for heap tracking',
        'Use PerformanceResourceTiming and PerformanceNavigationTiming for network analysis',
        'Create configurable alert rules with threshold-based monitoring',
        'Implement statistical analysis for memory leak detection using linear regression',
        'Build comprehensive dashboards with real-time metric updates and historical trends',
      ],
      estimatedTime: 90,
      filePath: './exercise-files/performance-optimization/08-performance-monitoring/exercise.tsx',
      solutionPath: './src/exercises/performance-optimization/08-performance-monitoring/solution.tsx',
      testsPath: './src/exercises/performance-optimization/08-performance-monitoring/test.ts',
      instructionsPath: './src/exercises/performance-optimization/08-performance-monitoring/instructions.md',
    },
  ],
};