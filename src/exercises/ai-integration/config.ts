...
export const aiIntegrationCategory: ExerciseCategory = {
  ...
  exercises: [
    ...
    {
      id: '09-collaborative-ai-features',
      title: 'Collaborative AI Features',
      description: 'Master multi-user AI collaboration and shared AI experiences with real-time synchronization and conflict resolution',
      category: 'ai-integration',
      difficulty: 5,
      prerequisites: ['03-ai-state-management', '08-ai-error-handling-resilience'],
      learningObjectives: [
        'Build comprehensive shared AI session management with real-time synchronization and state coordination',
        'Create collaborative prompting systems with shared context and intelligent merging',
        'Implement AI assistant systems with context awareness and collaborative features',
        'Design intelligent conflict resolution for simultaneous AI interactions and collaborative editing',
        'Master WebSocket-based real-time updates with optimistic UI patterns and connection resilience',
        'Develop sophisticated context sharing with permission systems and access control',
      ],
      hints: [
        'Implement WebSocket-based communication for real-time collaborative features',
        'Use operational transformation algorithms for conflict-free collaborative editing',
        'Create intelligent conflict detection with semantic understanding and resolution strategies',
        'Design shared context synchronization with versioning and collaborative history',
        'Build AI assistant integration with multi-user awareness and facilitation capabilities',
        'Add comprehensive permission systems with role-based access control and security',
      ],
      estimatedTime: 90,
      filePath: './exercise-files/ai-integration/09-collaborative-ai-features/exercise.tsx',
      solutionPath: './src/exercises/ai-integration/09-collaborative-ai-features/solution.tsx',
      testsPath: './src/exercises/ai-integration/09-collaborative-ai-features/test.ts',
      instructionsPath: './src/exercises/ai-integration/09-collaborative-ai-features/instructions.md',
    },
    {
      id: '10-ai-powered-workflows',
      title: 'AI-Powered Workflows',
      description: 'Build complex AI workflow orchestration systems with multi-step processing and intelligent result composition',
      category: 'ai-integration',
      difficulty: 5,
      prerequisites: ['05-tool-calling-integration', '07-ai-performance-optimization'],
      learningObjectives: [
        'Master comprehensive workflow orchestration with state management, task coordination, and execution control',
        'Implement intelligent AI orchestrators with dynamic routing, load balancing, and resource optimization',
        'Create sophisticated task pipelines with parallel processing, dependency management, and error recovery',
        'Build advanced result aggregation systems with intelligent composition and quality assessment',
        'Design interactive workflow visualization with real-time monitoring and debugging capabilities',
        'Develop robust error recovery systems with retry mechanisms, fallback strategies, and graceful degradation',
      ],
      hints: [
        'Use state machine-based workflow execution with dependency resolution and parallel processing',
        'Implement intelligent AI provider routing with cost optimization and capability matching',
        'Create multi-step pipelines with stage coordination and data flow management',
        'Design result aggregation with weighted merging, consensus algorithms, and conflict resolution',
        'Build workflow visualization with interactive diagrams and real-time monitoring',
        'Add comprehensive error handling with retry policies, recovery strategies, and performance optimization',
      ],
      estimatedTime: 90,
      filePath: './exercise-files/ai-integration/10-ai-powered-workflows/exercise.tsx',
      solutionPath: './src/exercises/ai-integration/10-ai-powered-workflows/solution.tsx',
      testsPath: './src/exercises/ai-integration/10-ai-powered-workflows/test.ts',
      instructionsPath: './src/exercises/ai-integration/10-ai-powered-workflows/instructions.md',
    },
  ],
};